...
\< [3.2. Reporter](3.2.-Reporter_47677461.md) \| [3.4.
Deployer](3.4.-Deployer_47677463.md) \>
...
5.  [Cisco Systems, \"Security Vulnerability Policy,\" \[Online\].
    Available:
    [https://www.cisco.com/c/en/us/about/security-center/security-vulnerability-policy.html](https://www.cisco.com/c/en/us/about/security-center/security-vulnerability-policy.md){.external-link
    rel="nofollow"}. \[Accessed 23 May
    2017\].]{style="color: rgb(23,43,77);text-decoration: none;"}
