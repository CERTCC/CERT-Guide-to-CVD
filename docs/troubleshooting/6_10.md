...
| # | d |     |     a         | predefined scope for their      |
| # | o | V   |               | vulnerability disclosure        |
|   | r | ali | vulnerability | policy. In most cases, that     |
| V |   | dat |               | shouldn't matter, because:     |
| e |   | ion |    disclosure |                                 |
| n |   | and |     program   | -   If the report is for a      |
| d |   | Tri |     with a    |     vulnerability that the      |
| o |   | age |     defined   |     vendor is able to fix, the  |
| r |   |     |     scope.    |     vendor should proceed with  |
|   |   |     | 2.  A report  |     the rest of the CVD process |
| r |   |     |     is        |     as if it were in scope      |
| e |   |     |     received  | -   If the report is for a      |
| c |   |     |     that      |     vulnerability that the      |
| e |   |     |     falls     |     vendor is unable to fix     |
| i |   |     |     outside   |     (e.g., it's not in the     |
| v |   |     |     of that   |     vendor's product but in a  |
| e |   |     |     scope.    |     library) the vendor may     |
| s |   |     |               |     redirect the reporter to    |
|   |   |     |               |     the originating vendor, or  |
| r |   |     |               |     could act as a coordinator  |
| e |   |     |               |     and engage the upstream     |
| p |   |     |               |     vendor directly.            |
| o |   |     |               | -   If the report is not for a  |
| r |   |     |               |     vulnerability but           |
| t |   |     |               |     represents a security       |
|   |   |     |               |     incident (e.g., data leaked |
| o |   |     |               |     on an open server), the     |
| u |   |     |               |     vendor can handle it as a   |
| t |   |     |               |     security incident.          |
| s |   |     |               | -   If the report is for a bug  |
| i |   |     |               |     that is otherwise not a     |
| d |   |     |               |     vulnerability, the vendor   |
| e |   |     |               |     can route the report to the |
|   |   |     |               |     appropriate developers for  |
| t |   |     |               |     remediation.                |
| h |   |     |               |                                 |
| e |   |     |               | In each of these cases, the     |
|   |   |     |               | reporter has provided useful    |
| s |   |     |               | information that is actionable  |
| c |   |     |               | by the vendor. Misdirected (out |
| o |   |     |               | of scope) reports provide       |
| p |   |     |               | vendors an opportunity to       |
| e |   |     |               | review and revise their         |
|   |   |     |               | published documentation and     |
| o |   |     |               | policies to ensure they're     |
| f |   |     |               | communicating clearly what they |
|   |   |     |               | do and do not expect to receive |
| t |   |     |               | via their CVD program.          |
| h |   |     |               |                                 |
| e |   |     |               | Even if the report indicates    |
| i |   |     |               | that the finder or reporter     |
| r |   |     |               | went far beyond the vendor's   |
|   |   |     |               | policy, it may still be         |
| r |   |     |               | appropriate to handle the       |
| e |   |     |               | report as if it were in         |
| p |   |     |               | compliance in order to avoid    |
| o |   |     |               | causing further problems for    |
| r |   |     |               | either the vendor or the        |
| t |   |     |               | reporter. Reporters can often   |
| i |   |     |               | be redirected toward acceptable |
| n |   |     |               | future behavior if their        |
| g |   |     |               | initial oversteps are treated   |
|   |   |     |               | as teachable moments rather     |
| p |   |     |               | than violations in need of      |
| r |   |     |               | punishment.                     |
| o |   |     |               |                                 |
| g |   |     |               |                                 |
| r |   |     |               |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | V | Rep | 1.  Vendor    | There are two issues at hand in |
| # | e | ort |     received  | this case:                      |
| # | n | ing |     report.   |                                 |
| # | d |     | 2.  Vendor's | 1.  Is there a vulnerability    |
| # | o | V   |     analysis  |     that the vendor needs to    |
|   | r | ali |     indicates |     respond to?                 |
| V |   | dat |     that      | 2.  Do the finder's actions    |
| e |   | ion |     other     |     constitute a security       |
| n |   | and |     policies  |     incident?                   |
| d |   | Tri |     were      |                                 |
| o |   | age |     violated  | Answering the first question in |
| r |   |     |     in the    | the affirmative, the vendor     |
|   |   | Re  |     discovery | should proceed as normal        |
| s |   | med |     process.  | through the remediation and     |
| u |   | iat |               | public awareness phases.        |
| s |   | ion |               |                                 |
| p |   |     |               | If the finder's actions are    |
| e |   |     |               | determined to qualify as a      |
| c |   |     |               | security incident of their own, |
| t |   |     |               | the vendor would do well to     |
| s |   |     |               | consider the implied            |
|   |   |     |               | beneficence on the part of the  |
| t |   |     |               | reporter in providing the       |
| h |   |     |               | report to the vendor in the     |
| e |   |     |               | first place. Yes, rules may     |
|   |   |     |               | have been broken, but sometimes |
| f |   |     |               | an *All's Well that Ends Well* |
| i |   |     |               | response is preferable. Gently  |
| n |   |     |               | reminding the reporter of the   |
| d |   |     |               | vendor's expectations can help |
| e |   |     |               | solidify a positive             |
| r |   |     |               | relationship between the vendor |
|   |   |     |               | and the research community.     |
| v |   |     |               |                                 |
| i |   |     |               | That said, the above advice     |
| o |   |     |               | should not be construed as a    |
| l |   |     |               | recommendation that vendors     |
| a |   |     |               | acquiesce to aggression or      |
| t |   |     |               | abuse from finders or           |
| e |   |     |               | reporters.                      |
| d |   |     |               |                                 |
|   |   |     |               |                                 |
| i |   |     |               |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | V | Rep | 1.  The       | Vulnerability rediscovery is    |
| # | e | ort |     vendor    | known to happen. It's usually  |
| # | n | ing |     had       | not a big deal if the Reporters |
| # | d |     |     received  | are cooperating with the        |
| # | o | V   |     a report  | Vendor.                         |
|   | r | ali |     of a      |                                 |
| V |   | dat |               | Vendors should attempt to       |
| e |   | ion | vulnerability | verify that the second report   |
| n |   | and | 2.  The       | is in fact independent of the   |
| d |   | Tri |     vendor    | first, and not simply a case of |
| o |   | age |     received  | the same report taking diverse  |
| r |   |     |     a second, | paths to reach the vendor.      |
|   |   | Re  |     seemingly |                                 |
| r |   | med |               | Vendors should re-evaluate any  |
| e |   | iat |  independent, | existing embargo and consider   |
| c |   | ion |     report of | accelerating the Remediation    |
| e |   |     |     the same  | and Public Awareness phases in  |
| i |   |     |               | light of the apparent ease with |
| v |   |     | vulnerability | which the vulnerability is      |
| e |   |     |               | being independently found.      |
| s |   |     | See also [6.5 |                                 |
|   |   |     | Independent   | Vendors should ensure any       |
| s |   |     | Discovery](6. | relevant bug bounty policies    |
| e |   |     | 5-Independent | define how this situation will  |
| c |   |     | -Discovery_47 | be handled with respect to      |
| o |   |     | 677487.md). | bounty payouts.                 |
| n |   |     |               |                                 |
| d |   |     |               | If the second report is made in |
|   |   |     |               | public rather than directly to  |
| r |   |     |               | the vendor, see also            |
| e |   |     |               | *Vulnerability becomes public   |
| p |   |     |               | prior to vendor intended date.* |
| o |   |     |               |                                 |
| r |   |     |               |                                 |
| t |   |     |               |                                 |
|   |   |     |               |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | V | V   | 1.  Multiple  | Questions of fairness arise if  |
| # | e | ali |     vendors   | some affected vendors are given |
| # | n | dat |     are       | advance notice of a             |
| # | d | ion |     likely to | vulnerability while others are  |
| # | o | and |     be        | notified only when it reaches   |
|   | r | Tri |     affected  | the Public Awareness phase. The |
| V |   | age |     by the    | goal should be to provide as    |
| u |   |     |     v         | much information as soon as     |
| l |   | Re  | ulnerability. | possible to all affected        |
| n |   | med | 2.  Many of   | vendors.                        |
| e |   | iat |     these     |                                 |
| r |   | ion |     vendors   | Vendors should provide          |
| a |   |     |     are       | communication channels for      |
| b |   |     |     dependent | their downstream vendors to     |
| i |   |     |     on the    | coordinate vulnerability        |
| l |   |     |               | response when needed. Ideally   |
| i |   |     |   originating | these channels are established  |
| t |   |     |     vendor    | and maintained on an ongoing    |
| y |   |     |     providing | basis, because constructing     |
|   |   |     |     a fix     | them in an ad-hoc manner in the |
| a |   |     |     before    | midst of a vulnerability case   |
| f |   |     |     they can  | can be time consuming and error |
| f |   |     |     take      | prone.                          |
| e |   |     |     action.   |                                 |
| c |   |     | 3.  The       | Vendors may wish to provide an  |
| t |   |     |               | extended embargo period so that |
| s |   |     |   originating | their downstream vendors have   |
|   |   |     |     vendor    | an opportunity to incorporate   |
| d |   |     |     may or    | changes before entering the     |
| o |   |     |     may not   | Public Awareness phase. This    |
| w |   |     |     know      | obviously works better in cases |
| n |   |     |     exactly   | where the originating vendor    |
| s |   |     |     who those | knows who most of its           |
| t |   |     |               | downstream vendors are. (See    |
| r |   |     |    downstream | *Vulnerability affects unknown  |
| e |   |     |     vendors   | downstream vendors* for         |
| a |   |     |     are or    | additional advice when they     |
| m |   |     |     how to    | don't.)                        |
|   |   |     |     reach     |                                 |
| v |   |     |     them.     | Cases where a significant user  |
| e |   |     |               | base (in terms of size or       |
| n |   |     | See also      | relative importance) may be     |
| d |   |     | *             | affected by the vulnerability   |
| o |   |     | Vulnerability | via unknown downstream          |
| r |   |     | affects       | vendors' products are an       |
| s |   |     | unknown       | argument in favor of shortened  |
|   |   |     | downstream    | embargo periods and increased   |
| { |   |     | vendors* and  | Public Awareness.               |
| # |   |     | *             |                                 |
| i |   |     | Vulnerability | Furthermore, the larger the     |
| d |   |     | affects       | number of involved parties, the |
| - |   |     | multiple      | more likely the embargo is to   |
| 6 |   |     | vendors with  | fail. Vendors in a supply chain |
| . |   |     | incompatible  | may consider whether legally    |
| 1 |   |     | disclosure    | binding disclosure agreements   |
| 0 |   |     | policies*     | are an appropriate means to     |
| T |   |     | below, as     | limit this risk. However, it's |
| r |   |     | well as [5.4  | often not feasible for all      |
| o |   |     | Multiparty    | parties to be placed under such |
| u |   |     | CVD](5.4-Mult | an agreement, which again       |
| b |   |     | iparty-CVD_47 | argues in favor of short        |
| l |   |     | 677477.md), | embargo periods.                |
| e |   |     | [5.5 Response |                                 |
| s |   |     | Pacing and    | Reporters and Vendors can       |
| h |   |     | Synchro       | engage the services of a third  |
| o |   |     | nization](5.5 | party Coordinator to assist     |
| o |   |     | -Response-Pac | with notifying other Vendors,   |
| t |   |     | ing-and-Synch | coordinating response along a   |
| i |   |     | ronization_47 | supply chain, resolving         |
| n |   |     | 677479.md), | disputes, etc.                  |
| g |   |     | and [5.6      |                                 |
| C |   |     | Maintaining   |                                 |
| o |   |     | P             |                                 |
| o |   |     | re-Disclosure |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | R | V   | 1.  Multiple  | Questions of fairness arise if  |
| # | e | ali |     vendors   | some affected vendors are given |
| # | p | dat |     are       | advance notice of a             |
| # | o | ion |     likely to | vulnerability while others are  |
| # | r | and |     be        | notified only when it reaches   |
|   | t | Tri |     affected  | the Public Awareness phase. The |
| V | e | age |     by the    | goal should be to provide as    |
| u | r |     |     v         | much information as soon as     |
| l |   | Re  | ulnerability. | possible to all affected        |
| n | V | med | 2.  Many of   | vendors.                        |
| e | e | iat |     these     |                                 |
| r | n | ion |     vendors   | Vendors should provide          |
| a | d |     |     are       | communication channels for      |
| b | o |     |     dependent | their downstream vendors to     |
| i | r |     |     on the    | coordinate vulnerability        |
| l |   |     |               | response when needed. Ideally   |
| i | C |     |   originating | these channels are established  |
| t | o |     |     vendor    | and maintained on an ongoing    |
| y | o |     |     providing | basis, because constructing     |
|   | r |     |     a fix     | them in an ad-hoc manner in the |
| a | d |     |     before    | midst of a vulnerability case   |
| f | i |     |     they can  | can be time consuming and error |
| f | n |     |     take      | prone.                          |
| e | a |     |     action.   |                                 |
| c | t |     | 3.  The       | For vulnerabilities affecting a |
| t | o |     |               | large number of unknown         |
| s | r |     |   originating | downstream vendors, the Public  |
|   |   |     |     vendor    | Awareness phase plays an        |
| u |   |     |     does not  | important part in identifying   |
| n |   |     |     know      | those vendors. Although         |
| k |   |     |     exactly   | publication may catch those by  |
| n |   |     |     who those | surprise in this case, it       |
| o |   |     |               | should also help establish the  |
| w |   |     |    downstream | aforementioned contact channel  |
| n |   |     |     vendors   | for future cases.               |
|   |   |     |     are or    |                                 |
| d |   |     |     how to    | [Reporters and Vendors can      |
| o |   |     |     reach     | engage the services of a third  |
| w |   |     |     them.     | party Coordinator to assist     |
| n |   |     |               | with notifying other Vendors,   |
| s |   |     | See also      | coordinating response along a   |
| t |   |     | *             | supply chain, resolving         |
| r |   |     | Vulnerability | disputes,                       |
| e |   |     | affects       | etc.]{                          |
| a |   |     | downstream    | style="letter-spacing: 0.0px;"} |
| m |   |     | vendors*      |                                 |
|   |   |     | above, [5.4   |                                 |
| v |   |     | Multiparty    |                                 |
| e |   |     | CVD](5.4-Mult |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | R | Rep | 1.  Multiple  | The coordinating parties        |
| # | e | ort |     vendors   | (Reporter, Vendor(s), and/or    |
| # | p | ing |     are       | Coordinator) have three         |
| # | o |     |     likely to | options:                        |
| # | r | V   |     be        |                                 |
|   | t | ali |     affected  | -   Shorten their embargo to    |
| V | e | dat |     by the    |     accommodate the fast-moving |
| u | r | ion |     v         |     vendor                      |
| l |   | and | ulnerability. | -   Delay notifying the the     |
| n | V | Tri | 2.  At least  |     fast-moving vendor until    |
| e | e | age |     one of    |     the other vendors are close |
| r | n |     |     those     |     enough that they'll be     |
| a | d | Re  |     vendors   |     ready for the Public        |
| b | o | med |     has a     |     Awareness phase at the same |
| i | r | iat |     policy or |     time as the fast-moving     |
| l |   | ion |     practice  |     vendor                      |
| i | C |     |     of        | -   Avoid notifying the         |
| t | o |     |               |     fast-moving vendor during   |
| y | o |     |    disclosing |     the embargo period, letting |
|   | r |     |     vu        |     them catch up once the      |
| a | d |     | lnerabilities |     vulnerability enters the    |
| f | i |     |     more      |     Public Awareness phase.     |
| f | n |     |     quickly   |                                 |
| e | a |     |     than      | The third is nearly always the  |
| c | t |     |     others.   | least optimal of the three      |
| t | o |     | 3.  That      | choices.                        |
| s | r |     |     vendor is |                                 |
|   |   |     |     unwilling |                                 |
| m |   |     |     to adjust |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | V | Re  | 1.  The       | If the Vendor is working toward |
| # | e | med |     Vendor is | a solution but needs more time  |
| # | n | iat |     aware of  | to complete its analysis,       |
| # | d | ion |     the       | development, or testing, it can |
| # | o |     |     v         | request an extension of the     |
|   | r |     | ulnerability. | embargo from the Reporter       |
| V |   |     | 2.  The       | and/or Coordinator (if any).    |
| e |   |     |     embargo   |                                 |
| n |   |     |     date is   | Vendors should recognize that   |
| d |   |     |               | (absent any binding agreement   |
| o |   |     |  approaching. | to the contrary) the embargo is |
| r |   |     | 3.  The       | a courtesy offered by the       |
|   |   |     |     Vendor is | Reporter or Coordinator to the  |
| i |   |     |     not ready | Vendor, but that Reporter or    |
| s |   |     |     yet.      | Coordinator policy or other     |
|   |   |     |               | considerations may supersede    |
| u |   |     | See [5.7      | the Vendor's desire for more   |
| n |   |     | Disclosure    | time.                           |
| p |   |     | Timin         |                                 |
| r |   |     | g](5.7-Disclo |                                 |
| e |   |     | sure-Timing_4 |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | V | Pub | 1.  The       | Vendors and Coordinators (if    |
| # | e | lic |     vendor is | any are involved) can often     |
| # | n | Awa |     aware of  | help their users, constituents, |
| # | d | ren |     the       | and the media to appropriately  |
| # | o | ess |     v         | calibrate their concern about a |
|   | r |     | ulnerability, | vulnerability by providing a    |
| A |   |     |     and may   | [clear and                      |
|   |   |     |     have      | accurate]{                      |
| v |   |     |     already   | style="letter-spacing: 0.0px;"} |
| u |   |     |     released  | representation of the facts.    |
| l |   |     |     a fix.    |                                 |
| n |   |     | 2.  There is  | Vendors should not attempt to   |
| e |   |     |               | squash the information already  |
| r |   |     |  considerable | available in the public sphere  |
| a |   |     |     media     | however. This often backfires,  |
| b |   |     |     attention | leading to even more publicity. |
| i |   |     |     drawn to  | It's better to let the         |
| l |   |     |     the       | vulnerability be the story      |
| i |   |     |     v         | rather than have the Vendor's  |
| t |   |     | ulnerability. | response to the vulnerability   |
| y |   |     |               | become the story.               |
|   |   |     | 1.  Sometimes |                                 |
| i |   |     |         this  |                                 |
| s |   |     |         is    |                                 |
...
| } |   |     |               |                                 |
+---+---+-----+---------------+---------------------------------+
| # | R | Rep | 1.            | All parties in a failing CVD    |
| # | e | ort |   Cooperation | case should consider their      |
| # | p | ing |     has       | actions in light of promoting   |
| # | o |     |     failed or | continued cooperation.          |
| # | r | V   |     is in the |                                 |
|   | t | ali |     process   | Reporters and Vendors can       |
| A | e | dat |     of        | engage the services of a third  |
|   | r | ion |     failing   | party Coordinator to assist     |
| C |   | and |     within    | with notifying other Vendors,   |
| V | V | Tri |     the       | coordinating response along a   |
| D | e | age |     context   | supply chain, resolving         |
|   | n |     |     of a      | disputes, etc.                  |
| c | d | Re  |               |                                 |
| a | o | med |    particular |                                 |
| s | r | iat |     CVD case. |                                 |
| e |   | ion |               |                                 |
|   | C |     | See also [6.7 |                                 |
| j | o | Pub | Relationships |                                 |
| u | o | lic | that Go       |                                 |
| s | r | Awa | Sideway       |                                 |
| t | d | ren | s](6.7-Relati |                                 |
|   | i | ess | onships-that- |                                 |
| i | n |     | Go-Sideways_4 |                                 |
| s | a |     | 7677489.md) |                                 |
| n | t |     |               |                                 |
